/*! For license information please see main.c2728c90.js.LICENSE.txt */
(() => {
  var e = {
      700: (e, t, n) => {
        'use strict';
        ...
        const a = (0, r.zD)('news/fetchNews', async (e, t) => {
          ...
          try {
            return (
              await o.A.get(
                `https://api.polygon.io/v2/reference/news?ticker=${e}&apiKey=oRw9ebHARHpYDonYIt4VNoYoOPhplFBV`
              )
            ).data.results;
          } catch (r) {
            return r.response && 403 === r.response.status
              ? n('Access forbidden: check API key and permissions.')
              : n('Error fetching news');
          }
        });
      },
      3783: (e, t, n) => {
              ...
              e.addCase(o.EN.fulfilled, (e, t) => {
                ...
                (e.data =
                  null === (n = t.payload) || void 0 === n
                    ...
                    : n.ticker.prevDay.o),
                  (e.error = null);
              }).addCase(o.EN.rejected, (e, t) => {
                (e.data = null), (e.error = t.payload);
              });
            },
          }),
          { setStockPrice: i } = a.actions,
          u = a.reducer;
      },
      247: (e, t, n) => {
        'use strict';
        ...
        var r = n(3536),
          ...
          a = n(6213),
          i = n(158);
        const u = 'oRw9ebHARHpYDonYIt4VNoYoOPhplFBV',
          l = (0, o.zD)('stocks/fetchStocks', async (e, t) => {
            let { getState: n } = t;
            const r = `https://api.polygon.io/v2/aggs/ticker/${
                n().user.symbol
              }/range/1/day/2023-01-01/2023-12-31?apiKey=${u}`,
              o = await fetch(r);
            if (!o.ok) throw new Error('Failed to fetch stock data');
            return (await o.json()).results;
          }),
          s = (0, o.zD)(
            'stocks/fetchStocks',
            (0, r.debounce)(async (e, t) => {
              let { rejectWithValue: n, dispatch: r } = t;
              try {
                const t = await a.A.get(
                  `https://api.polygon.io/v2/snapshot/locale/us/markets/stocks/tickers/${e}?apiKey=${u}`
                );
                return r((0, i.o)(t.data.ticker.prevDay.o)), t.data;
              } catch (o) {
                return o.response && 403 === o.response.status
                  ? n('Access forbidden: check API key and permissions.')
                  : n('Error fetching stock price');
              }
            }, 300)
          );
        (0, o.zD)('stocks/fetchDividends', async (e, t) => {
          let { rejectWithValue: n } = t;
          try {
            return (
              await a.A.get(
                `https://api.polygon.io/v3/reference/dividends?ticker=${e}&apiKey=${u}`
              )
            ).data.results;
          } catch (r) {
            return r.response && 403 === r.response.status
              ? n('Access forbidden: check API key and permissions.')
              : n('Error fetching dividend data');
          }
        });
      },
      1083: (e, t, n) => {
      ...
      9751: (e, t, n) => {
        ...
        const r = (0, n(6756).Z0)({
            name: 'user',
            initialState: { symbol: '', stockPrice: null },
            reducers: {
              setUserSymbol(e, t) {
                e.symbol = t.payload;
              },
              setStockPrice(e, t) {
                e.stockPrice = t.payload;
              },
            },
            extraReducers: (e) => {},
          }),
          { setUserSymbol: o, setStockPrice: a } = r.actions,
          i = r.reducer;
      },
      3051: (e, t, n) => {
        'use strict';
      ...
      1387: (e, t, n) => {
        ...
        function p(e, t, n, i) {
          ...
          function y() {
            ...
            let e = g(),
              t = null == e ? null : e - m;
            (m = e), v && v({ action: h, location: w.location, delta: t });
          }
          function b(e) {
            let t =
          ...
          null == m &&
            ((m = 0), p.replaceState(r({}, p.state, { idx: m }), ''));
          let w = {
            get action() {
              return h;
            },
            ...
            listen(e) {
              ...
              return (
                ...
                (v = e),
                () => {
                  l.removeEventListener(a, y), (v = null);
                }
              );
            },
            createHref: (e) => t(l, e),
        ...
        (e = n.nmd(e)),
          function () {
            var o,
              ...
              Je =
                ...
                ('(?:' +
                  ...
                  ')*'),
              Ge = '(?:' + [De, Be, We].join('|') + ')' + Je,
              Ze = '(?:' + [Me + ze + '?', ze, Be, We, je].join('|') + ')',
              et = RegExp(Ne, 'g'),
              tt = RegExp(ze, 'g'),
              nt = RegExp(Ue + '(?=' + Ue + ')|' + Ze + Je, 'g'),
              rt = RegExp(
                [
                  $e +
                    '?' +
            ...
            var yn = (function e(t) {
              ...
              function Gn(e, t) {
                return La(To(e), ur(t, 0, e.length));
              }
              function Zn(e) {
                return La(To(e));
              }
              ...
              function Pr(e, t, r) {
                ...
                e: for (; ++p < i && f.length < c; ) {
                  var v = d[p],
                    m = t ? t(v) : v;
                  if (
                    ((v = r || 0 !== v ? v : 0), !(h ? tn(h, m) : a(f, m, r)))
                  ) {
                    for (l = u; --l; ) {
                      var g = s[l];
                      if (!(g ? tn(g, m) : a(e[l], m, r))) continue e;
                    }
                    h && h.push(m), f.push(v);
                  }
                }
              ...
              function Hr(e, t, n, r) {
                var o = r ? Vt : $t,
                  ...
                  i = t.length,
                  u = e;
                for (e === t && (t = To(t)), n && (u = Lt(e, Zt(n))); ++a < i; )
                  for (
              ...
              function wo(e, t) {
                return Vi(e) ? e : _a(e, t) ? [e] : Da(yu(e));
              }
              var _o = Xr;
              function So(e, t, n) {
                var r = e.length;
              ...
              function Yo(e) {
                ...
                return function (e, n) {
                  if (
                    ((e = mu(e)), (n = null == n ? 0 : bn(hu(n), 292)) && bt(e))
                  ) {
              ...
              function Zo(e, t, n, r) {
                return e === o || (Mi(e, je[n]) && !Le.call(r, n)) ? t : e;
              }
              ...
              function la(e) {
                return (Le.call(Mn, 'placeholder') ? Mn : e).placeholder;
              }
              function sa() {
              ...
              ((En && va(new En(new ArrayBuffer(1))) != L) ||
                (xn && va(new xn()) != x) ||
                (Cn && va(Cn.resolve()) != R) ||
                (On && va(new On()) != T) ||
                (Rn && va(new Rn()) != A)) &&
              ...
              var Ma = Xr(function (e, t) {
                  return Ki(e) ? fr(e, gr(t, 1, Ki, !0)) : [];
                }),
                Ba = Xr(function (e, t) {
                  var n = Xa(t);
                  return (
                    Ki(n) && (n = o),
                    Ki(e) ? fr(e, gr(t, 1, Ki, !0), sa(n, 2)) : []
                  );
                }),
                Wa = Xr(function (e, t) {
                  var n = Xa(t);
                  return (
                    Ki(n) && (n = o), Ki(e) ? fr(e, gr(t, 1, Ki, !0), o, n) : []
                  );
                });
              function $a(e, t, n) {
              ...
              var ti = Xr(function (e) {
                  return co(gr(e, 1, Ki, !0));
                }),
                ni = Xr(function (e) {
                  var t = Xa(e);
                  return Ki(t) && (t = o), co(gr(e, 1, Ki, !0), sa(t, 2));
                }),
                ri = Xr(function (e) {
                  var t = Xa(e);
                  return (
              ...
              var ii = Xr(function (e, t) {
                ...
                li = Xr(function (e) {
                  var t = Xa(e);
                  return Ki(t) && (t = o), mo(jt(e, Ki), sa(t, 2));
                }),
                si = Xr(function (e) {
                  var t = Xa(e);
                  return (
                    (t = 'function' == typeof t ? t : o), mo(jt(e, Ki), o, t)
                  );
                }),
                ci = Xr(oi);
              ...
              function Ni(e, t, n) {
                ...
                function b() {
                  ...
                  if (((r = arguments), (i = this), (c = e), n)) {
                    if (s === o)
                      return (function (e) {
                        return (f = e), (s = Na(g, t)), d ? v(e) : l;
                      })(c);
                    if (p) return ko(s), (s = Na(g, t)), v(c);
                  }
                  return s === o && (s = Na(g, t)), l;
                }
                return (
                  (t = mu(t) || 0),
                  eu(n) &&
                    ((d = !!n.leading),
                    (u = (p = 'maxWait' in n) ? Qt(mu(n.maxWait) || 0, t) : u),
              ...
              function zi(e, t) {
                ...
                return (n.cache = new (zi.Cache || Kn)()), n;
              }
              function Li(e) {
                if ('function' != typeof e) throw new Pe(a);
                return function () {
              ...
              var Bi = Ko(Cr),
                ...
                $i = Nr(
                  ...
                  : function (e) {
                      return (
                        tu(e) && Le.call(e, 'callee') && !Qe.call(e, 'callee')
                      );
                    },
                Vi = n.isArray,
                qi = _t
              ...
              function Hi(e) {
                return null != e && Zi(e.length) && !Ji(e);
              }
              function Ki(e) {
                return tu(e) && Hi(e);
              }
              ...
              function ou(e) {
                ...
                return (
                  'function' == typeof n && n instanceof n && ze.call(n) == Ue
                );
              }
              var au = Et
                ? Zt(Et)
              ...
              var Eu = Xr(function (e, t) {
                  ...
                  for (a && wa(t[0], t[1], a) && (r = 1); ++n < r; )
                    for (
                      ...
                      var c = u[l],
                        f = e[c];
                      (f === o || (Mi(f, je[c]) && !Le.call(e, c))) &&
                        (e[c] = i[c]);
                    }
                  return e;
                }),
                xu = Xr(function (e) {
                  return e.push(o, ea), Ot(zu, o, e);
                });
              function Cu(e, t, n) {
              ...
              var Ru = Wo(function (e, t, n) {
                ...
                Tu = Xr(Tr);
              function Nu(e) {
                return Hi(e) ? Xn(e) : Dr(e);
              }
              function ju(e) {
                return Hi(e) ? Xn(e, !0) : Fr(e);
              }
              var Au = Ao(function (e, t, n) {
                  Wr(e, t, n);
                }),
                zu = Ao(function (e, t, n, r) {
                  Wr(e, t, n, r);
                }),
                Lu = ra(function (e, t) {
                  var n = {};
              ...
              return (
                ...
                (Mn.curry = function e(t, n, r) {
                  var a = Go(t, 8, o, o, o, o, o, (n = r ? o : n));
                  return (a.placeholder = e.placeholder), a;
                }),
                (Mn.curryRight = function e(t, n, r) {
                  var a = Go(t, l, o, o, o, o, o, (n = r ? o : n));
                  return (a.placeholder = e.placeholder), a;
                }),
                (Mn.debounce = Ni),
                (Mn.defaults = Eu),
                ...
                (Mn.flatMapDepth = function (e, t, n) {
                  return (n = n === o ? 1 : hu(n)), gr(ki(e, t), n);
                }),
                (Mn.flatten = qa),
                ...
                (Mn.toPath = function (e) {
                  return Vi(e) ? Lt(e, Fa) : lu(e) ? [e] : To(Da(yu(e)));
                }),
                (Mn.toPlainObject = gu),
                ...
                (Mn.escape = function (e) {
                  return (e = yu(e)) && J.test(e) ? e.replace(Y, an) : e;
                }),
                (Mn.escapeRegExp = function (e) {
                  return (e = yu(e)) && ae.test(e) ? e.replace(oe, '\\$&') : e;
                }),
                ...
                (Mn.forIn = function (e, t) {
                  return null == e ? e : yr(e, sa(t, 3), ju);
                }),
                ...
                (Mn.repeat = function (e, t, n) {
                  return (
                    (t = (n ? wa(e, t, n) : t === o) ? 1 : hu(t)), Yr(yu(e), t)
                  );
                }),
                (Mn.replace = function () {
                  var e = arguments,
                ...
                (Mn.size = function (e) {
                  if (null == e) return 0;
                  if (Hi(e)) return uu(e) ? hn(e) : e.length;
                  var t = va(e);
                ...
                (Mn.trimStart = function (e, t, n) {
                  if ((e = yu(e)) && (n || t === o)) return e.replace(ie, '');
                  if (!e || !(t = so(t))) return e;
                  var r = vn(e);
                  ...
                  if ((u && (l += s.length - l), au(a))) {
                    if (e.slice(l).search(a)) {
                      var c,
                        f = s;
                      for (
                        a.global || (a = Oe(a.source, yu(ve.exec(a)) + 'g')),
                          a.lastIndex = 0;
                        (c = a.exec(f));
                ...
                (Mn.unescape = function (e) {
                  return (e = yu(e)) && X.test(e) ? e.replace(Q, gn) : e;
                }),
      ...
      2730: (e, t, n) => {
        ...
        function Be(e, t, n, r, o, a, i, u, l) {
          (De = !1), (Fe = null), Le.apply(Me, arguments);
        }
        function We(e) {
          var t = e,
            n = e;
        ...
        function Hr(e, t) {
          for (var n = t + 'Capture', r = []; null !== e; ) {
            ...
            5 === o.tag &&
              null !== a &&
              ((o = a),
              null != (a = je(e, n)) && r.unshift(qr(e, a, o)),
              null != (a = je(e, t)) && r.push(qr(e, a, o))),
              (e = e.return);
          }
          return r;
        }
        ...
        function Qr(e, t, n, r, o) {
          for (var a = t._reactName, i = []; null !== n && n !== r; ) {
            ...
            5 === u.tag &&
              ...
              ((u = s),
              o
                ? null != (l = je(n, a)) && i.unshift(qr(n, l, u))
                : o || (null != (l = je(n, a)) && i.push(qr(n, l, u)))),
              (n = n.return);
          }
        ...
        function ea(e, t, n) {
          (Qo[Yo++] = Jo), (Qo[Yo++] = Go), (Qo[Yo++] = Xo), (Xo = e);
          var r = Jo;
          e = Go;
          var o = 32 - it(r) - 1;
          (r &= ~(1 << o)), (n += 1);
        ...
        function na(e) {
          for (; e === Ho; )
            (Ho = Vo[--qo]), (Vo[qo] = null), (Ko = Vo[--qo]), (Vo[qo] = null);
          for (; e === Xo; )
            (Xo = Qo[--Yo]),
              (Qo[Yo] = null),
              (Go = Qo[--Yo]),
        ...
        function wa(e) {
          ...
          function s(e, t, n, r) {
            ...
            return a === k
              ...
              : (((r = zs(n.type, n.key, n.props, null, e.mode, r)).ref = ga(
                  e,
                  t,
                  n
                )),
          ...
          function d(e, t, n) {
            ...
            if ('object' === typeof t && null !== t) {
              switch (t.$$typeof) {
                case _:
                  return (
                    ((n = zs(t.type, t.key, t.props, null, e.mode, n)).ref = ga(
                      e,
                      null,
                      t
                    )),
        ...
        function Xa(e, t) {
          switch ((Oo(Qa, t), Oo(Ka, e), Oo(Ha, qa), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function Ku(e, t, n) {
          ...
          switch ((na(t), t.tag)) {
            ...
            case 6:
              if (e && null != t.stateNode) zu(e, t, e.memoizedProps, r);
                ...
                if ('string' !== typeof r && null === t.stateNode)
                  throw Error(a(166));
                if (((n = Ya(Qa.current)), Ya(Ha.current), da(t))) {
                  if (
                    ((r = t.stateNode),
                    (n = t.memoizedProps),
                    (r[po] = t),
            ...
            case 10:
              return Ra(t.type._context), Hu(t), null;
            case 19:
              if ((Co(ei), null === (i = t.memoizedState))) return Hu(t), null;
                  ...
                  for (Gu = o; null !== Gu; )
                    (l = (i = Gu).child),
                      22 === i.tag && null !== i.memoizedState
                        ...
                        ? ((l.return = i), (Gu = l))
                        : Sl(o);
                for (; null !== a; ) (Gu = a), bl(a, t, n), (a = a.sibling);
                (Gu = o), (Yu = u), (Xu = s);
              }
              wl(e);
            } else
        ...
        var kl,
          ...
          Zl = 0;
        function es() {
          return 0 !== (6 & Rl) ? Je() : -1 !== Gl ? Gl : (Gl = Je());
        }
        function ts(e) {
          return 0 === (1 & e.mode)
            ? 1
        ...
        function os(e, t) {
          if (((Gl = -1), (Zl = 0), 0 !== (6 & Rl))) throw Error(a(327));
          var n = e.callbackNode;
          ...
          if (0 !== t) {
            if (
              ...
              throw ((n = Ll), ds(e, 0), us(e, r), rs(e, Je()), n);
            if (6 === t) us(e, r);
            else {
              if (
        ...
        function ls(e) {
          ...
          if (1 === n) throw ((n = Ll), ds(e, 0), us(e, t), rs(e, Je()), n);
        ...
        function hs() {
          var e = xl.current;
          return (xl.current = Gi), null === e ? Gi : e;
        }
        function vs() {
          (0 !== zl && 3 !== zl && 2 !== zl) || (zl = 4),
            null === Pl ||
        ...
        function xs(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Pl === e &&
              (Nl & n) === n &&
              (4 === zl ||
              (3 === zl && (130023424 & Nl) === Nl && 500 > Je() - Bl)
                ? ds(e, 0)
                : (Il |= n)),
            rs(e, t);
        }
        ...
        const h =
          ...
          m = a.forwardRef(function (e, t) {
            let n,
              ...
              k = !1;
            if ('string' === typeof g && v.test(g) && ((n = g), h))
              try {
      ...
      3216: (e, t, n) => {
        ...
        function b(e, t, n, r) {
          ...
          if (t) {
            ...
            '/' === m ||
              (null == (b = e.pathname) ? void 0 : b.startsWith(m)) ||
              (0, a.Oi)(!1),
              (g = e);
          } else g = y;
          let w = g.pathname || '/',
        ...
        function z(e, t) {
          ...
          return (
            o.Children.forEach(e, (e, r) => {
              ...
              e.props.children && (u.children = z(e.props.children, i)),
                n.push(u);
            }),
            n
          );
      ...
      6756: (e, t, n) => {
        ...
        function $(e, t) {
          ...
          return (
            void 0 !== e && e !== n
              ? (n[m].modified_ && (U(t), g(4)),
                w(e) && ((e = V(t, e)), t.parent_ || H(t, e)),
                t.patches_ &&
        ...
        function V(e, t, n) {
          if (A(t)) return t;
          const r = t[m];
          if (!r) return k(t, (o, a) => q(e, r, t, o, a, n)), t;
            ...
            constructor(e) {
              ...
              (this.autoFreeze_ = !0),
                ...
                (this.produce = (e, t, n) => {
                  ...
                  let r;
                  if (
                    ('function' !== typeof t && g(6),
                    void 0 !== n && 'function' !== typeof n && g(7),
                    w(e))
                  ) {
                    const o = B(this),
                      a = Z(e, void 0);
        ...
        function he(e) {
          ...
          const v = (function () {
            ...
            m = pe(v);
          return l(d, i, h(...('function' === typeof f ? f(m) : m())));
        }
        function ve(e) {
          const t = {},
            n = [];
          ...
          ke = (() => {
            function e(e, t, n) {
              ...
              return Object.assign(
                function (e) {
                  return (i, u, l) => {
                    const s = n?.idGenerator ? n.idGenerator(e) : ye(),
      ...
      6213: (e, t, n) => {
        ...
        const G = V.toFlatObject(V, {}, null, function (e) {
                ...
                return (
                  ...
                  u.forEach(function (e, r) {
                    !V.isUndefined(e) &&
                      null !== e &&
                      t.append(
                        !0 === i ? J([n], r, a) : null === i ? n : n + '[]',
                        l(e)
                      );
                  }),
                  !1
                );
            return !!Y(e) || (t.append(J(o, n, a), l(e)), !1);
          }
          const c = [],
            f = Object.assign(G, {
              defaultVisitor: s,
        ...
        const Me = (e) => {
            ...
            if (
              ...
              (o && V.isFunction(o) && (o = o(t)), o || (!1 !== o && Le(t.url)))
            ) {
          ...
          Ke = He && 'function' === typeof ReadableStream,
          Qe =
            He &&
        ...
        const Xe = function (e) {
          ...
          Ge = Ke && Xe(() => V.isReadableStream(new Response('').body)),
          Ze = { stream: Ge && ((e) => e.body) };
        var et;
        He &&
          ((et = new Response()),
            ...
            fetch:
              ...
              (async (e) => {
                ...
                try {
                  ...
                  let a = await fetch(p);
                  const i = Ge && ('stream' === s || 'response' === s);
                  if (Ge && (u || (i && v))) {
                    const e = {};
                  ...
                  s = s || 'text';
                  let g = await Ze[V.findKey(Ze, s) || 'text'](a, e);
                  return (
                    !i && v && v(),
        ...
        function ut(e) {
          ...
          return at(e.adapter || ge.adapter)(e).then(
            function (t) {
              return (
                it(e),
      ...
      3003: (e, t, n) => {
        ...
        function b(e, t) {
          ...
          function l() {
            o--, n && 0 === o && (n(), (n = void 0), r.clear(), (r = y));
          }
          const s = {
  ...
  (n.m = e),
    ...
    (() => {
        ...
        extraReducers: (e) => {
          e.addCase(u.Y.pending, (e) => {
            ...
            .addCase(u.Y.fulfilled, (e, t) => {
              (e.loading = !1), (e.articles = t.payload), (e.error = null);
            })
      ...
      var m = n(3216),
        g = n(247);
      const y = (0, e.lazy)(() => n.e(602).then(n.bind(n, 6602))),
        b = (0, e.lazy)(() => n.e(72).then(n.bind(n, 5072))),
        w = (0, e.lazy)(() =>
          Promise.all([n.e(446), n.e(854)]).then(n.bind(n, 8854))
        ),
        _ = (0, e.lazy)(() =>
          Promise.all([n.e(495), n.e(461)]).then(n.bind(n, 5897))
        ),
        S = (0, e.lazy)(() => n.e(436).then(n.bind(n, 6436))),
        k = (0, e.lazy)(() =>
          Promise.all([n.e(662), n.e(779), n.e(811)]).then(n.bind(n, 2811))
        ),
        E = (0, e.lazy)(() =>
          Promise.all([n.e(446), n.e(14)]).then(n.bind(n, 7633))
        ),
        x = (0, e.lazy)(() => n.e(822).then(n.bind(n, 1822))),
        C = (0, e.lazy)(() =>
          Promise.all([n.e(446), n.e(474), n.e(947)]).then(n.bind(n, 2947))
        ),
        O = (0, e.lazy)(() =>
          Promise.all([n.e(204), n.e(383)]).then(n.bind(n, 1710))
        ),
        R = (0, e.lazy)(() =>
          Promise.all([n.e(446), n.e(474), n.e(887)]).then(n.bind(n, 1887))
        ),
        P = (0, e.lazy)(() => n.e(724).then(n.bind(n, 1724)));
      const T = function () {
          const [t, n] = (0, e.useState)(!0),
            o = (0, r.wA)(),
            a = (0, r.d4)((e) => e.theme),
            [i, u] = (0, e.useState)(localStorage.getItem('lastStock'));
          return (
            (0, e.useEffect)(() => {
              o((0, s.Km)(i)), o((0, g.AZ)(i)), o((0, g.EN)(i));
            }, [o, i]),
            (0, h.jsxs)('div', {
              className: 'd-flex ' + (t ? '' : 'toggled'),
              id: 'wrapper',
              children: [
                (0, h.jsx)(e.Suspense, {
                  fallback: (0, h.jsx)('div', { children: 'Loading...' }),
                  children: (0, h.jsx)(O, {}),
                }),
                (0, h.jsxs)('div', {
                  ...
                  children: [
                    (0, h.jsxs)(e.Suspense, {
                      ...
                      children: [
                        (0, h.jsx)(R, {
                          ...
                          toggleTheme: () => {
                            const e = 'light' === a ? 'dark' : 'light';
                            o((0, f.Y)(e)), localStorage.setItem('theme', e);
                          },
                        }),
                        (0, h.jsx)(E, {}),
                      ],
                    ...
                    (0, h.jsx)('div', {
                      ...
                      children: (0, h.jsx)(e.Suspense, {
                        fallback: (0, h.jsx)('div', { children: 'Loading...' }),
                        children: (0, h.jsxs)(m.BV, {
                          children: [
                            (0, h.jsx)(m.qh, {
                              path: '/',
                              element: (0, h.jsx)(y, {}),
                    ...
                    (0, h.jsx)(e.Suspense, { children: (0, h.jsx)(P, {}) }),
                  ],
                }),
              ],
            })
      ...
      t.createRoot(document.getElementById('root')).render(
        (0, h.jsx)(e.StrictMode, {
          children: (0, h.jsx)(v, { children: (0, h.jsx)(T, {}) }),
        })
      ),
        N();
    })();
})();
//# sourceMappingURL=main.c2728c90.js.map
